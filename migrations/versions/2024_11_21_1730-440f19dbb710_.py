...
Revision ID: 440f19dbb710
Revises: 
Create Date: 2024-11-21 17:30:43.207477
...
def upgrade() -> None:
    ...
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('action', sa.Enum('CREATE', 'READ', 'UPDATE', 'DELETE', name='permissionaction'), nullable=False),
